...
eta_p = ((2*c.R_u*T)/c.F)*asinh(-u/(2*p.A_p*p.L_p*a_p*k_p*(c.c_e*c_p*(p.c_max_p-c_p))^(0.5)));
eta_n = ((2*c.R_u*T)/c.F)*(asinh(u/(2*n.A_n*n.L_n*a_n*k_n*(c.c_e*c_n*(n.c_max_n-c_n))^(0.5))));
